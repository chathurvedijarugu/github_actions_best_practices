...
const LabDetailsCard: React.FC<Props> = (props: Props) => {
    const useStyles = makeStyles({
        root: {
            ...
            border: props.selected ? `2px solid ${theme.palette.secondary.main}` : "none",
            cursor: "pointer",
        },
    ...
    return (
        <Grid className={classes.root} onClick={props.onClick} data-testid="lab-details">
                ...
                <Grid item container className={classes.frame}>
                    ...
                    <Grid item className={classes.innerFrame}>
                        ...
                        <Grid item className={classes.slots}>
                            <Typography variant="caption1">{props.slots} Slots Available</Typography>
                        </Grid>
                    </Grid>
                </Grid>
                <Grid item className={classes.timeInfo}>
                    <Typography variant="caption2">Reports ready in {props.time}</Typography>
                </Grid>
